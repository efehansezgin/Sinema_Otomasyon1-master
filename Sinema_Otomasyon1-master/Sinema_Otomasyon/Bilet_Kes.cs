...
namespace Sinema_Otomasyon
{
    public partial class Bilet_Kes : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=DESKTOP-OQH5QGJ;Initial Catalog=sinema;User ID=sa;Password=.;");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ekle.Dispose();
            MessageBox.Show("Bilet Kesme sİşleminiz Başarıyla Gerçekleşmiştir.");
